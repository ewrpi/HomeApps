...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function showUser() {
        ...
        var name = document.getElementById("userDD").value;
    ...
    function addCBsToWeeklyStats() {
        ...
        var table = document.getElementById("ctl00_ContentPlaceHolder1_gvStats");
    ...
    function openWinLossStats() {
        var e = document.getElementById("ctl00_ContentPlaceHolder1_ddlYears");
...
<%--<%} %>--%>
    ...
    <hr />
            ...
            Font-Size="XX-Large" ForeColor="Yellow" Text="Matchups this Week"></asp:Label>
                    <asp:LinkButton ID="linkRefresh" runat="server" onclick="linkRefresh_Click">Refresh</asp:LinkButton>
